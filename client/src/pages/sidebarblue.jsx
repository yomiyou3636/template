...
function Sidebarblue() {
  return (
    ...
    <Back />  
     <nav className='absolute group grid gap-4 grid-rows-9 rounded-r-lg h-screen w-[8vw]  bg-gradient-to-t from-blue-900 to-blue-500 hover:w-[20vw] transition-all ease-in-out duration-500  pt-5 shadow-blue-500-lg '>
