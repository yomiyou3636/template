...
// document.getElementById('onee').style.transition='500s'
    ...
    return (<> <Back />
        <div className='w-full h-screen flex justify-center items-center'> 
            ...
            <div id='sign' className='min-w-[50%] h-full font-sans flex flex-col items-center  mt-5 pt-4 '>
         ...
         <div className='w-[80%] h-[60%]  grid gird-rows-4 gap-2 mt-2'>
            ...
            <div className='flex justify-center items-center'><button className='bg-gradient-to-r from-red-500 to-pink-700 w-[60%] h-[70%] text-white rounded-lg'>SIGN UP</button></div>
            

         </div>
                </div>
                <div id='sign' className='min-w-[50%] h-full font-sans flex flex-col items-center  pt-4 '>
...
<BiLogoFacebook  className='border-[2px] p-[2px] border-slate-30000 rounded-full' /> <AiOutlineGooglePlus  className='border-[2px] p-[2px] border-slate-30000 rounded-full'/><BiLogoLinkedin  className='border-[2px] p-[2px] border-slate-30000 rounded-full' />
         ...
         <p className=' mt-6 font-sans'>or use your account</p>
         <div className='w-[80%] h-[60%]  grid gird-rows-4 gap-2 mt-2'>
            <input type="text" placeholder='Email' className='focus:outline-none pl-3 bg-slate-100 text-[17px] rounded-lg' />
            <input type="text" placeholder='Password' className='focus:outline-none pl-3 bg-slate-100 text-[17px] rounded-lg'/>
            <p className='flex justify-center items-center '>Forgot password ?</p> 
            <div className='flex justify-center items-center'><button className='bg-gradient-to-r from-red-500 to-pink-700 w-[60%] h-[70%] text-white rounded-lg'>SIGN IN</button></div>
