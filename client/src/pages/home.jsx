         ...
         <div className=' fixed w-full h-[60px] flex justify-center font-bold items-end   text-white text-[30px] pb-2 bg-slate-900 '>LOG IN</div>
          <div id="login" className='w-full h-full ms:h-screen  grid-col-1 grid-rows-6 px-6  grid sm:grid-cols-3 sm:grid-rows-2 pt-3 mt-[60px] gap-5  py-8'>
            <div className='border-8 border-gray-800 bg-red-700 flex flex-col '>
              <Link to="/login1" className='w-full h-[70%] bg-cover bg-center bg-no-repeat' style={{ backgroundImage: `url(${movable})` }}></Link>
           ...
           <div className='border-8 border-gray-800 bg-red-700 flex flex-col '>
              <Link to="/login2" className='w-full h-[70%] bg-cover bg-center bg-no-repeat' style={{ backgroundImage: `url(${snakepic})` }}></Link>
           ...
           <div className='border-8 border-gray-800 bg-red-700 flex flex-col '>
              <Link to="/login3" className='w-full h-[70%] bg-cover bg-center bg-no-repeat' style={{ backgroundImage: `url(${purplesign})` }}></Link>
           ...
           <div className='border-8 border-gray-800 bg-red-700 flex flex-col '>
              <Link to="/login4" className='w-full h-[70%] bg-cover bg-center bg-no-repeat' style={{ backgroundImage: `url(${glowimg})` }}></Link>
           ...
           <div className='border-8 border-gray-800 bg-red-700 flex flex-col '>
              <Link to="/login5" className='w-full h-[70%] bg-cover bg-center bg-no-repeat' style={{ backgroundImage: `url(${bluetoplogin})` }}></Link>
           ...
           <div className='border-8 border-gray-800 bg-red-700 flex flex-col '>
              <Link to="/login6" className='w-full h-[70%] bg-cover bg-center bg-no-repeat' style={{ backgroundImage: `url(${pinksignin})` }}></Link>
   ...
   <div className='h-full w-full flex flex-col'>
         <div className=' fixed w-full h-[60px] flex justify-center font-bold items-end  text-white text-[30px] pb-2 bg-slate-900 '>SIDEBAR</div>
          <div id="login" className='w-full h-full ms:h-screen  grid-col-1 grid-rows-6  grid sm:grid-cols-3 sm:grid-rows-2 pt-3 mt-[60px] gap-5 px-6 py-8'>
              <div className='border-8 border-gray-800 bg-red-700 flex flex-col '>
              <Link to="/sidebar1" className='w-full h-[70%] bg-cover bg-start bg-no-repeat' style={{ backgroundImage: `url(${bluesidebar1})` }}></Link>
              ...
              <div className='border-8 border-gray-800 bg-red-700 flex flex-col '>
              <Link to="/sidebar2" className='w-full h-[70%] bg-cover bg-start bg-no-repeat' style={{ backgroundImage: `url(${navgreen})` }}></Link>
              ...
              <div className='border-8 border-gray-800 bg-red-700 flex flex-col '>
              <Link to="/sidebar3" className='w-full h-[70%] bg-cover bg-start bg-no-repeat' style={{ backgroundImage: `url(${indigologin})` }}></Link>
           ...
           <div className='border-8 border-gray-800 bg-red-700 flex flex-col '>
              <Link to="/sidebar4" className='w-full h-[70%] bg-cover bg-start bg-no-repeat' style={{ backgroundImage: `url(${balcksidebar})` }}></Link>
              <div className='w-full h-[30%] bg-slate-800 text-sm p-2 text-slate-200 text-wrap'>
A black and orange sidebar holds nested buttons, a profile picture, and a menu button revealing the sidebar on click.</div>
           </div>
           <div className='border-8 border-gray-800 bg-red-700 flex flex-col '>
              <Link to="/sidebar5" className='w-full h-[70%] bg-cover bg-start bg-no-repeat' style={{ backgroundImage: `url(${interact})` }}></Link>
           ...
           <div className='border-8 border-gray-800 bg-red-700 flex flex-col '>
              <Link to="/sidebar6" className='w-full h-[70%] bg-cover bg-start bg-no-repeat' style={{ backgroundImage: `url(${brownsidebar})` }}></Link>
         ...
         <div className='h-full w-full flex flex-col'>
          ...
          <div id="login" className='w-full h-full ms:h-screen  grid-col-1 grid-rows-6  grid sm:grid-cols-3 sm:grid-rows-2 pt-3 mt-[60px] gap-5 px-6  py-8'>
             <div className='border-8 border-gray-800 bg-red-700 flex flex-col '>
              ...
              <div className='border-8 border-gray-800 bg-red-700 flex flex-col '>
              <Link to="/imageview1" className='w-full h-[70%] bg-cover bg-center bg-no-repeat' style={{ backgroundImage: `url(${frameimg})` }}></Link>
           ...
           <div className='border-8 border-gray-800 bg-red-700 flex flex-col '>
              <Link to="/imageview2" className='w-full h-[70%] bg-cover bg-center bg-no-repeat' style={{ backgroundImage: `url(${imgviewwide})` }}></Link>
...
{infoboxVisible && (
   ...
   <div className='h-full w-full flex flex-col'>
         <div className=' fixed w-full h-[60px] flex justify-center font-bold items-end  text-white text-[30px] pb-2 bg-slate-900 '>CARD</div>
          <div id="login" className='w-full h-full ms:h-screen  grid-col-1 grid-rows-6  grid sm:grid-cols-3 sm:grid-rows-2 pt-3 mt-[60px] gap-5 px-6  py-8'>
              <div className='border-8 border-gray-800 bg-red-700 flex flex-col '>
              <Link to="/card1" className='w-full h-[70%] bg-cover bg-center bg-no-repeat' style={{ backgroundImage: `url(${avtcard})` }}></Link>
           ...
           <div className='border-8 border-gray-800 bg-red-700 flex flex-col '>
              <Link to="/card2" className='w-full h-[70%] bg-cover bg-center bg-no-repeat' style={{ backgroundImage: `url(${colorscard})` }}></Link>
              <div className='w-full h-[30%] bg-slate-800 text-sm p-2 text-slate-200 text-wrap'>
A card featuring a subtle depression at the top, housing icons, and a gradient background for the remaining body.</div>
           </div>
           <div className='border-8 border-gray-800 bg-red-700 flex flex-col '>
              <Link to="/card3" className='w-full h-[70%] bg-cover bg-center bg-no-repeat' style={{ backgroundImage: `url(${codecard})` }}></Link>
           ...
           <div className='border-8 border-gray-800 bg-red-700 flex flex-col '>
              <Link to="/card4" className='w-full h-[70%] bg-cover bg-center bg-no-repeat' style={{ backgroundImage: `url(${cornorcard})` }}></Link>
              <div className='w-full h-[30%] bg-slate-800 text-sm p-2 text-slate-200 text-wrap'>
A card with sleek display of   icons  at the top corner  and   information  display below.
</div>
           </div>
           <div className='border-8 border-gray-800 bg-red-700 flex flex-col '>
              <Link to="/card5" className='w-full h-[70%] bg-cover bg-center bg-no-repeat' style={{ backgroundImage: `url(${citybox})` }}></Link>
              <div className='w-full h-[30%] bg-slate-800 text-sm p-2 text-slate-200 text-wrap'>

              A dual-section card featuring an image on top and information below, casting a shadow to create a fading effect.</div>           </div>
           <div className='border-8 border-gray-800 bg-red-700 flex flex-col '>
              <Link to="/card6" className='w-full h-[70%] bg-cover bg-center bg-no-repeat' style={{ backgroundImage: `url(${topbox})` }}></Link>
