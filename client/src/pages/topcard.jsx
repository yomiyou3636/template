    ...
    <div className='w-full sm:h-screen h-[200dvh] py-5 sm:py-0 bg-slate-900 flex justify-center items-center'>
        <div className='sm:w-[60%] w-[90%] h-full sm:h-[65%]  grid gap-4 grid-rows-3 sm:grid-rows-1 sm:grid-cols-3'>
            <div className='bg-white  shadow-lg  flex  overflow-hidden flex-col'>
                ...
                <div className='w-full h-[60%] bg-slate-800 gap-1  p-3  flex flex-col   justify-start pt-5'>
...
<div className=' mt-3 flex justify-between  gap-2'>
  <button className= 'border-2 border-blue-500 text-blue-500 bg-slate-800  py-1  text-[17px] w-[45%]'>Follow</button>
  <button className= 'border-2  text-white bg-slate-800  py-1  text-[14px] w-[45%]'>MORE INFO</button>
  </div>
...
<div className=' mt-3 flex justify-between  gap-2'>
  <button className= 'border-2 border-red-500 text-red-500 bg-slate-800  py-1  text-[17px] w-[45%]'>Follow</button>
  <button className= 'border-2  text-white bg-slate-800  py-1  text-[14px] w-[45%]'>MORE INFO</button>
  </div>
...
<div className=' mt-3 flex justify-between  gap-2'>
  <button className= 'border-2 border-green-500 text-green-500 bg-slate-800  py-1  text-[17px] w-[45%]'>Follow</button>
  <button className= 'border-2  text-white bg-slate-800  py-1  text-[14px] w-[45%]'>MORE INFO</button>
  </div>
