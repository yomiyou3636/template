...
document.getElementById('sign').style.fontSize='40px'
    ...
    const hendlesignin=()=>{
        document.getElementById('login').style.marginTop='-280px'
...
<div id='login' className=' pt-4 transition-all ease-in-out duration-500 w-full min-h-[60%] bg-white flex flex-col justify-start items-center rounded-t-[100px] '>
