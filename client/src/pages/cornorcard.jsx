...
<div className='w-full h-[60%] flex flex-col items-center justify-center gap-2 p-2'>
    ...
    <button className='text-[23px]  rounded-xl font-bold text-slate-900 bg-[#269ff6] p-2 w-[50%] h[35px]'>Design</button>
</div>
            </div>
            <div className=' border-[8px] border-[#ff206b] bg-slate-900 rounded-[15px] rounded-tl-[70px] overflow-hidden '>
<div className=' w-full h-[40%] flex justify-start items-start'>
...
<div className='w-full h-[60%] flex flex-col items-center justify-center gap-2 p-2'>
    <h1 className='text-white font-bold font-sans text-[25px]'>DESIGN</h1>
    <p className='text-white font-sans text-center '> Lorovident dict dolor sit amet consectetur adipisicitis eum numquam? aepe accusantium a molestiae ipsum. ex.</p>
    <button className='text-[23px]  rounded-xl font-bold text-slate-900 bg-[#ff206b] p-2 w-[50%] h[35px]'>Design</button>
</div>
            </div>
            <div className=' border-[8px] border-[#99fe26] bg-slate-900 rounded-[15px] rounded-tl-[70px] overflow-hidden '>
<div className=' w-full h-[40%] flex justify-start items-start'>
...
<div className='w-full h-[60%] flex flex-col items-center justify-center gap-2 p-2'>
    <h1 className='text-white font-bold font-sans text-[25px]'>DESIGN</h1>
    <p className='text-white font-sans text-center '> Lorovident dict dolor sit amet consectetur adipisicitis eum numquam? aepe accusantium a molestiae ipsum. ex.</p>
    <button className='text-[23px]  rounded-xl font-bold text-slate-900 bg-[#99fe26] p-2 w-[50%] h[35px]'>Design</button>
</div>
            </div>
        </div>
